    ...
    <div className="min-h-screen bg-[#f8fafc] text-[#0f172a] flex flex-col font-sans antialiased selection:bg-emerald-500 selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-slate-200/90 px-5 py-2.5 flex items-center justify-between shadow-xs">
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={onBack}>
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-[#059669] to-[#0f766e] flex items-center justify-center shadow-sm">
            ...
            <div>
              <div className="font-display font-bold text-base text-[#0f172a] leading-none">
                SiteScope
              </div>
                ...
                {cities.map((c) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-xs flex items-center justify-between ${
                      c.id === selectedCityId ? "bg-emerald-50 text-emerald-800 font-bold" : "text-slate-600 hover:bg-slate-50"
                    }`}
                  >
                    <span>{c.name}, {c.region}</span>
                    {c.id === selectedCityId && <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />}
                  </button>
                ))}
              </div>
            )}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative hidden md:block w-72">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 rounded-xl border border-slate-200 bg-slate-50 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 focus:bg-white transition-all"
            />
          </div>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-semibold shadow-sm transition-all"
          >
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200/90 shadow-xs">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-5 h-5 rounded-lg bg-emerald-100 flex items-center justify-center text-[#064e3b]">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-3 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-800 appearance-none pr-8 focus:outline-none focus:border-emerald-500"
              >
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200/90 shadow-xs">
            <div className="flex items-center justify-between mb-3 pb-1 border-b border-slate-100">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[11px] text-[#059669] hover:underline font-semibold"
              >
                💾 Save Site
              </button>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-tr from-emerald-600 via-teal-500 to-sky-600 flex items-center justify-center text-white font-bold text-xs shadow-inner flex-shrink-0">
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200/90 shadow-xs">
            ...
            <div className="flex items-center gap-4">
              <div className="relative w-20 h-20 rounded-full bg-emerald-50 border-4 border-[#10b981] flex flex-col items-center justify-center shadow-xs flex-shrink-0">
          ...
          {/* AI Insight Card */}
          <div className="bg-[#f0fdf4] rounded-2xl p-4 border border-emerald-200/80 shadow-xs">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5 text-[#065f46] font-bold text-xs">
                <Sparkles className="w-3.5 h-3.5 text-amber-500" />
                <span>AI Strategic Insight</span>
              </div>
              <span className="text-[9px] font-bold font-mono px-1.5 py-0.5 rounded bg-emerald-200/70 text-[#064e3b] uppercase">
                Beta
              </span>
            </div>
      ...
      <footer className="sticky bottom-0 z-30 bg-white/95 backdrop-blur border-t border-slate-200 px-6 py-2.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            onClick={() => setIsCopilotOpen(true)}
            className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-semibold shadow-sm transition-all"
          >
            <Bot className="w-3.5 h-3.5" />
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-[#064e3b] hover:bg-[#047857] text-white text-xs font-semibold shadow-sm transition-colors"
          >
